...
import dk.tinker.authservice.api.dto.user.CreateUserRequest;
import dk.tinker.authservice.api.dto.user.UpdateUserRequest;
import dk.tinker.authservice.api.dto.user.UserResponse;
import dk.tinker.authservice.domain.User;
import dk.tinker.authservice.exception.ConflictException;
